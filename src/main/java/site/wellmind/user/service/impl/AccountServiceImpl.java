...
public class AccountServiceImpl implements UserService {
    ...
    public UserDto save(UserDto dto) {
        ...
        try{
            ...
            Optional<UserTopModel> user=userTopRepository.findByEmployeeId(dto.getEmployeeId());
            Optional<AdminTopModel> admin=adminTopRepository.findByEmployeeId(dto.getEmployeeId());
